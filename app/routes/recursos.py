...
def create():
    ...
    return render_template("recursos/form.html", TIPO_RECURSO=TIPO_RECURSO, recurso=None)
...
def edit(id):
    ...
    return render_template("recursos/form.html", TIPO_RECURSO=TIPO_RECURSO, recurso=recurso, nav=nav)
