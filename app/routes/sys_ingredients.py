...
def list():
    ...
    return render_template("sys_ingredients/list.html", ingredients=ingredients, fields=INGREDIENTS_FIELDS, ctx=ctx, TIPO_INGREDIENTE=TIPO_INGREDIENTE)
