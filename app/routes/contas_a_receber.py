...
def list():
    ...
    return render_template(
        "contas_a_receber/list.html", previsoes=previsoes, total_saldo=total_saldo,
...
def edit(id):
    ...
    if request.method == "POST":
        ...
        if prev_total > transacao.valor:
            ...
            return render_template(
                ...
                PREVISAO_STATUS=PREVISAO_STATUS,
                submitted_data=submitted_data, submitted_previsoes=submitted_previsoes,
                nav=nav, movimentos=movimentos, tipo_nome="Recebimento",
            )
    ...
    return render_template(
        ...
        movimentos=movimentos, tipo_nome="Recebimento",
    )
