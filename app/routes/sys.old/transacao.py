...
TRANSACAO_FIELDS = {
        ...
        'previsto': {'width': 10, 'input': 'number', 'align': 'right', 'currency': 'brl'},
        'realizado': {'width': 10, 'input': 'number', 'align': 'right', 'currency': 'brl'},
        'variacao': {'label': 'Variação', 'width': 10, 'input': 'number', 'align': 'right', 'currency': 'brl'},
        'saldo': {'width': 10, 'input': 'number', 'align': 'right', 'currency': 'brl'},
