...
def plano():
    secoes = _build_tree()
    return render_template("sys_rubricas/plano.html", secoes=secoes, TIPO_RUBRICA=TIPO_RUBRICA)
...
def new():
    ...
    return render_template("sys_rubricas/form.html", TIPO_RUBRICA=TIPO_RUBRICA, paises=paises)
...
def edit(id):
    ...
    return render_template("sys_rubricas/form.html", rubrica=rubrica, nav=nav, TIPO_RUBRICA=TIPO_RUBRICA, paises=paises)
