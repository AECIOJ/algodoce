...
def new():
    ...
    return render_template("sys_products/form.html", ingredients=ingredients, categorias=categorias, etapas=etapas)
...
def edit(id):
    ...
    return render_template(
        "sys_products/form.html", product=product, ingredients=ingredients, categorias=categorias, etapas=etapas, nav=nav
    )
