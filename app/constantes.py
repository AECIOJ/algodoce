...
PEDIDO_STATUS = {0: "Pendente", 1: "Faturado", 2: "Produzindo", 3: "Pronto",
                 8: "Cancelado", 9: "Entregue"}

COMPRA_STATUS = {0: "Orçamento", 1: "Pedido", 2: "Faturado", 6: "Cancelado", 8: "Recebido", 9: "Devolvido"}

ORCAMENTO_STATUS = {0: "Pendente", 1: "Negociação", 6: "Renovado",
