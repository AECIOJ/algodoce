...
class Config:
    ...
    APP_VERSION_YEAR = os.getenv("APP_VERSION_YEAR", "2026")
    APP_VERSION_MONTH = os.getenv("APP_VERSION_MONTH", "01")
    APP_VERSION_SEQUENCE = os.getenv("APP_VERSION_SEQUENCE", "001")
