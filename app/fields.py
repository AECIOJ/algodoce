...
FIELD_ID_SHORT   = {'label': '#', 'mask': '999', 'input': 'number', 'readonly': True, 'filter': FILTER_NUMBER}
...
FIELD_ATIVO      = {'input': 'boolean', 'readonly': True, 'filter': FILTER_BOOLEAN}
...
FIELD_TOTAL      = {'input': 'number', 'align': 'right', 'aggregate': 'sum', 'currency': 'brl', 'readonly': True, 'filter': FILTER_NUMBER}
...
FIELD_STATUS     = {'input': 'select', 'readonly': True, 'filter': FILTER_SELECT}
