...
dataclasses (`Field`, `Query`, `Button`, `Report`, `Form`, `List`, `Editor`),
tabelas de tipos, constantes e resolução de campos. Não depende de
renderização (`core/form`, `core/list`, `core/query`), de request nem do
